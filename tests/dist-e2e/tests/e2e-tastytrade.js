...
const SUPABASE_URL = process.env.SUPABASE_URL || "https://dyrwkxdwszvqpzvodgxl.supabase.co";
const SUPABASE_ANON_KEY = process.env.SUPABASE_ANON_KEY || "YOUR_SUPABASE_ANON_KEY";
const ACCOUNT_NUMBER = process.env.TASTYTRADE_ACCOUNT_NUMBER || "YOUR_TASTYTRADE_ACCOUNT_NUMBER";
const SYMBOL_TO_SEARCH = process.env.TASTYTRADE_SYMBOL_TO_SEARCH || "AAPL";
const E2E_ALLOW_LIVE_ORDERS = process.env.E2E_ALLOW_LIVE_ORDERS || "false";
